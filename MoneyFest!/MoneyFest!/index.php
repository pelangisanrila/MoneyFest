...
<img class="polygon-3" src="img/polygon-3.svg" />
                        ...
                        <div class="sign-in-from bg-white">
                            ...
                            <form class="mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-0" id="username" placeholder="Enter your username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="gender" name="gender" placeholder="Your Full Name">
                                        ...
                                        <option value="female">Financial Consultant</option>
                                    </select>
                                </div>
