            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active"><a href="Reports.php" class="iq-waves-effect"><i class="las la-file-contract"></i><span>Financial Reports</span></a></li>
         ...
         <div id="content-page" class="content-page">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-6 col-lg-6">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height overflow-hidden">
                        <div class="iq-card-body">
                           ...
                           <h4 class="card-title">Enter Dates</h4>
                        </div>
                                 ...
                                 <div class="row">
                                    <div class="form-group col-sm-6">
                                       ...
                                       <div class="input-group">
                                             <input type="date" class="form-control datepicker" id="startDate" placeholder="Select start date" autocomplete="off">
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <div class="input-group">
                                             <input type="date" class="form-control datepicker" id="endDate" placeholder="Select end date" autocomplete="off">
                  ...
                  <div class="col-md-6 col-lg-6">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height overflow-hidden">
                        <div class="iq-card-body p-0 text-center">
                           <br><br>
                           <!-- Tombol Download -->
                           <button class="btn btn-primary col-md-9 mb-2" onclick="downloadFunction()">Download</button>

                           <!-- Tombol Print -->
                           <button class="btn btn-outline-success col-md-9 mb-2" onclick="printFunction()">Print</button><br>

                           <!-- Tombol Share -->
                           <button class="btn btn-outline-info col-md-9 mb-2" onclick="shareFunction()">Share</button>
                        </div>
                     </div>
                  </div>
